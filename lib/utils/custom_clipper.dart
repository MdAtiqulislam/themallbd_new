...
class CustomPaintClipper extends CustomClipper<Path> {
  ...
  CustomPaintClipper({required this.position});
  ...
  Path getClip(Size size) {
    ...
    if(position=="left"){
      ...
      path.quadraticBezierTo(0, height/2, width, height);
      path.quadraticBezierTo(width/4, height/4, width/4, height/4);
      path.quadraticBezierTo(width/2, height/2, width/2, height/2);
