...
import '../../../controllers/blogs/beauty_feed_controller.dart';
import '../../../widgets/custom_bottom_navigation_bar.dart';
import '../../../widgets/custom_drawer.dart';
import '../../../widgets/responsive_helper.dart';
import 'blog_auto_scroll_slider.dart';

class BeautyFeed extends StatelessWidget {
  BeautyFeed({Key? key}) : super(key: key);
  final BeautyFeedController beautyFeedController =
      Get.put(BeautyFeedController());
          ...
          child: Row(
            ...
            children: [
              (beautyFeedController.isLoadingBlogData.value)
                  ...
                  : HeaderText(
                      text:
                          "${beautyFeedController.blogData?.length ?? ""} Articles",
                      color: Colors.grey,
                    ),
      ...
      () => beautyFeedController.isLoadingBlogData.value
          ...
          : SliverList(
              delegate: SliverChildBuilderDelegate(
                    ...
                    child: InkWell(
                      onTap: () {
                        Get.toNamed("/blog_view",
                            arguments:
                            beautyFeedController.blogData![index].id);
                      },
                      child: Column(
                        ...
                        children: [
                          ...
                          Image.network(beautyFeedController.blogData?[index].image??"",
                          ...
                          /*FadeInImage(
                            ...
                            image: NetworkImage(
                              beautyFeedController.blogData![index].image
                                  .toString(),
                            ),
                          ),*/
                          Padding(
                ...
                childCount: beautyFeedController.blogData!.length,
